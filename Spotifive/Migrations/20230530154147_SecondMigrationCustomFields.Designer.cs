...
namespace Spotifive.Migrations
{
    ...
    [Migration("20230530154147_SecondMigrationCustomFields")]
    partial class SecondMigrationCustomFields
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Spotifive.Models.EditorSongs", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Spotifive.Models.PlaylistSongs", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Spotifive.Data.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Spotifive.Models.UserSongs", b =>
                {
                    ...
                    b.HasOne("Spotifive.Models.RegisteredUser", "RegisteredUser")
                        .WithMany()
                        .HasForeignKey("UserID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
